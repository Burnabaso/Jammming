  ...
  return(
    <>
     <div className="xs:hidden  bg-action2 dark:bg-action2-dark w-full flex justify-between items-center py-5 px-3 md:px-0 md:justify-around">
          ...
          <button className="hover:cursor-pointer bg-action dark:bg-action-dark text-xl text-center py-3 px-2 rounded-md text-white font-semibold transition-all hover:font-bold" onClick={props.handleLogout}>Logout</button>
          }
          <h1 className="text-4xl h-fit font-bold">Ja<span className="text-action">mmm</span>ing</h1> 
          <label className="inline-flex items-center bg-action dark:bg-action-dark p-3 rounded-md shadow-lg transition-all">
